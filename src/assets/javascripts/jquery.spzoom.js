(function($, undefined) {
    ...
    $.fn.spzoom.defaults = {
        width: 150,             // Zoom window width in pixels
        height: 150,            // Zoom window height in pixels
    ...
    Spzoom.prototype.render = function() {
        ...
        switch (this.options.position) {
            ...
            default: // default is right
                ...
                if ($(document).height() < zoom_y + this.options.height) {
                    //alert();
                    zoom_x = thumb_x - this.options.margin;
                    zoom_y = thumb_y - this.options.height - this.options.margin;
                }
        }
